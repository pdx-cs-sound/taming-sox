...
```bash
sox source.wav out.wav highpass 200     # remove rumble below 200 Hz
sox source.wav out.wav lowpass 8000     # remove hiss above 8 kHz
sox source.wav out.wav highpass 300 lowpass 3400   # telephone band
```
...
```bash
sox source.wav out.wav bass 3      # boost bass by 3 dB
sox source.wav out.wav treble -6   # cut treble by 6 dB
sox source.wav out.wav bass 2 treble -2
```
...
```bash
sox source.wav out.wav equalizer 1000 200 -6    # cut 6 dB at 1 kHz
sox source.wav out.wav equalizer 3000 150 3     # boost 3 dB at 3 kHz
```
